<template>
	<div class="min-h-full">
		<header>
			<nav
				class="bg-white border-b border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800"
			>
...
import ToggleButtons from "./navbar/ToggleButtons.vue";
import Logo from "./navbar/Logo.vue";
import SearchBar from "./navbar/SearchBar.vue";
import SidebarNav from "./navbar/SidebarNav.vue";
